...
| [0009](0009-confidential-compute-variants.md) | Confidential-compute variants (TEE / SEV / TDX) | Superseded | Removed in the 6.12.96/6.18.39 audit: no substrate machine model and no bootable firmware/initrd wiring |
...
exposes, including removal of the unbootable TEE inventory). 0010 records a process decision — how the docs
